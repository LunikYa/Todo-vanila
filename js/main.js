...
function removeAll(){
    ...
    showTasks(res, true);
    check = !check;
    document.getElementsByClassName('img-complete-all')[0].src = './img/complete-all.png'
}
...
function sortTasks(event){	
	...
	if (event.target.tagName === 'SPAN'){
	    ...
	    let result = tasksArr.filter((item)=>{
...
// <ul class="list-tasks" id="js-list-tasks">

// </ul>    


// class List {
//     constructor(domNode, /*Object?*/options) {

//     }

//     render(/**Array*/data) {
//         data.array.forEach(this.addListItem);
//     }
